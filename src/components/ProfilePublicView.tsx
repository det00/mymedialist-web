...
const mockCollection = {
  inProgress: [
    ...
    },
    {
      ...
      image:
        "https://m.media-amazon.com/images/I/91DZsbCHcbL._AC_UF1000,1000_QL80_.jpg",
      progress: "45%",
    },
  ],
  completed: [
    ...
    },
    {
      ...
      image:
        "https://image.api.playstation.com/vulcan/img/rnd/202010/2618/Y02L3BPV8NtWrYV1y4AkJcC3.jpg",
    },
  ],
  planned: [
    {
...
export function ProfilePublicView({ idUsuario }: { idUsuario: number }) {
  ...
  const { datosPerfil, loading } = useProfile(idUsuario);
  
  if (loading || !datosPerfil) {
    return (
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator
        .share({
          title: `Perfil de ${profileData.nombre} en MyMediaList`,
          text: `Échale un vistazo al perfil de ${profileData.nombre} en MyMediaList`,
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  {/* <span className="text-sm font-medium">{profileData.estadisticas.completados}</span> */}
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground flex items-center gap-1">
                  ...
                  <span className="text-sm font-medium">
                    {datosPerfil.estadisticas.enProgreso}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground flex items-center gap-1">
                  ...
                  <span className="text-sm font-medium">
                    {datosPerfil.estadisticas.pendiente}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground flex items-center gap-1">
                  ...
                  <span className="text-sm font-medium">
                    {datosPerfil.estadisticas.abandonado}
                  </span>
                </div>
              </div>
            </div>
                      ...
                      <div className="flex-1 space-y-2">
                        <div>
                          <Badge className="mb-1">
                            ...
                            <span className="ml-1">
                              {getContentTypeName(activity.content.type)}
                            </span>
                          </Badge>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {datosPerfil.nombre}{" "}
                          {renderActivityType(activity.type)} este{" "}
                          {getContentTypeName(
          ...
          <TabsContent value="friends" className="mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {datosPerfil.nombre} tiene {mockFriends.length} amigos
                </CardDescription>
              </CardHeader>
              <CardContent>
